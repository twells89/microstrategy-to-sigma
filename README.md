...
> The `microstrategy-to-sigma` skill now lives in the consolidated monorepo:
> **https://github.com/twells89/sigma-migration-skills** → `plugins/microstrategy-to-sigma/`
